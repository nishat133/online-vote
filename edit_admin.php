	      ...
	      if($db_connect){
			...
			$db_select=mysqli_select_db($db_connect,'online vote');
			 ...
			 die('connection fail'.mysqli_error($db_connect));
				...
				$nishat="UPDATE adlog SET username='$_POST[name]',password='$_POST[password]',image='$dst1' WHERE admin_id='$_POST[admin_id]'";
...
<html lang="en">
  <head>
    ...
    <title>Update Admin informtion here</title>
				...
				<div class="col-md-6 col-md-offset-2">
					<form action="" method="POST" enctype="multipart/form-data" >
					  ...
					  <div class="form-group">
						...
						<input type="text" class="form-control" name="name" placeholder=""  maxlength="10" value=" ">
					  </div>
					  <div class="form-group">
						<label for="Name">password</label>
						<input type="text" class="form-control" name="password" placeholder=" "  maxlength="10" value="">
					  </div>
					   
					  
					  <div class="form-group">
						<label for="password">Candidate Id</label>
						<input type=" " class="form-control" name="admin_id" placeholder="" value=" ">
					  </div>
