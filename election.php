...
<html lang="en">
  <head>
    ...
    <title>election Informtion</title>
  ...
  <body>
  <div class="content">
  <h1> <marquee>  You can ADD DELETE and UPDATE election informtion here </marquee></h1>
  </div>
	<div class="page-wrap">
  ...
  <div class="containk2er-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
           ...
           <li class="active"><a href="view_elec.php"> View Election <span class="sr-only">(current)</span></a></li>
				...
				<div class="col-md-6 col-md-offset-2">
					<form action="addelection.php" method="post" enctype="multipart/form-data" >
					  ...
					  <div class="form-group">
					   ...
					   <div class="form-group">
						<label for="id">how many Candidate are</label>
						<input type="id" class="form-control" name="candidate_id" placeholder=" ">
					  </div>
