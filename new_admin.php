...
<html lang="en">
  <head>
    ...
    <title> New admin Informtion</title>
  ...
  <body>
  <div class="content"><h1> New Admin </h1>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="view_admin.php">  View Admin <span class="sr-only">(current)</span></a></li>
		...
		<li class="active"><a href="logout.php"> Log out <span class="sr-only">(current)</span></a></li>
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-2">
					<form action="ad_admin.php" method="post" enctype="multipart/form-data" >
					  
					  <div class="form-group">
						<label for="Name">User Name</label>
						<input type="Name" class="form-control"  name="username" placeholder="Type user Name Here" required>
					  </div>
					   <div class="form-group">
						<label for="id">password</label>
						<input type="password" class="form-control" name="password" placeholder="Type  password Here" required>
					  </div>
					   <div class="form-group">
